...
void buffer_event(long, long, long, struct input_event, int);
void sched_rel_mouse_event(struct input_event, long, int);
void sched_abs_mouse_event(struct input_event, long, int);
void main_loop();
void usage();
void banner();
